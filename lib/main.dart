...
import 'package:portfolio/portfolio/splash_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        MyProjectList.projectList : (context) => const  MyProjectList(),
        MySkillScreen.skillScreen : (context) => const MySkillScreen(),
